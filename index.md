...
>  * Input: A graph (G), starting restaurant node (start_node_cx), and a threshold for similarity (threshold_cx)
>  * Output: Returns oriented tree, constructed from a depth-first-search from source, of similar restaurants, and accompanying text for context
...
print("Restaurants most similar to " + start_node_c1 + ": \n" + str(subgraph_c1.nodes()))
...
**Output**
```
Restaurants most similar to Tomo: 
['Tomo', 'Ocean Sushi', 'Arirang']

Restaurants most similar to Mona Lisa Pizzeria: 
['Mona Lisa Pizzeria', 'The Square on Annadale']

Restaurants most similar to Il Sogno: 
['Il Sogno', "DeLuca's", 'La Fontana Sorellena']
```

**Interpretation of Results**:
>The nodes of the tree generated tells us which restaurants are most similar to what we inputted, as to analyze the diversity of cuisines, as well as how unique the restaurants are.
